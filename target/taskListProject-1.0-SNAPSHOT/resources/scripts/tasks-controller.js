tasksController = function () {
    ...
    const SORT_TASK_ORDER_ASCEND = "ascend";
    const SORT_TASK_ORDER_DESCEND = "descend";
    ...
    function filterByTeam(id) {
        ...
        serverTaskData = serverTaskData.filter((t) => t.user.team.id == id ? true : false);
